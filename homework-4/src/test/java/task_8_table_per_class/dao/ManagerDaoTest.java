...
public class ManagerDaoTest extends BaseDaoTest {
    ...
    ManagerDao targetObject;

    @Before
    public void setUp() throws Exception {
        targetObject = new ManagerDao(testSessionFactory);
    }
    ...
    public void findById() {
        ...
        //When
        Manager manager = targetObject.findById(101);
        assertNotNull(manager);

        //Then
        assertEquals("Google", manager.getCompany());
        assertEquals("Gmail", manager.getProjectName());
